// Package viacep provides HTTP clients for external CEP APIs (ViaCEP and BrasilAPI).
package api_viacep
...
// GetAddressByViaCepZipcode fetches address data from ViaCEP by zip code.
// Returns the normalized address or an error on HTTP or decode failure.
func GetAddressByViaCepZipcode(zipCode string) (mappers.Address, error) {
